    ...
    <div class="row">
        ...
        <div class="col-9" style="padding: 30px">
            <div style="text-align: center">
                <i style="margin-right:10px;font-size:25px;" class="bi bi-activity"></i><span style="font-size:25px;font-weight:700">Add Activity</span>
            </div>
            <br><br>
            <div class="form" style="margin-left:10%;margin-right:20%">    
                <form action="/add-activity" method="POST" style="background-color: white;padding:70px;">
                    @csrf
